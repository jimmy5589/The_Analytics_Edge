...
You should use repeated K-fold cross-validation to measure your out-of-sample accuracy. Your test set accuracy suffers from some randomness -- and repeated K-fold cross-validation captures that randomness by giving you a distribution of potential test set accuracy rates.

> summary(cv.perf)

Call:
summary.resamples(object = cv.perf)
...
glm    0.5925  0.6092 0.6122 0.6145  0.6208 0.6400    0
glmnet 0.6065  0.6275 0.6329 0.6309  0.6361 0.6445    0

Here's some code that you can run:
